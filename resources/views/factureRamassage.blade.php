    ...
    <div class="invoice-box">
        ...
        <table>
            <tr class="heading">
                <td>ID Commande</td>
                <td>Client</td>
                <td>Frais Ramassage</td>
                <td>Date Ramassage</td>
                <td>Statut</td>
            </tr>
            @foreach($data2 as $key)
            <tr class="item">
                <td>{{ $key->id_ramassage }}</td>
                <td>{{ $key->username }}</td>

                @if($key->prix_ramassage!=null)
                <td>{{ $key->prix_ramassage }} Dhs</td>
                @elseif($key->pourcentage_ramassage!=null)
                <td>{{ $key->pourcentage_ramassage }} %</td>
                @endif
                


                <td>{{ $key->date_ramassage }}</td>
                <td>{{$key->statut_facture}}</td>
