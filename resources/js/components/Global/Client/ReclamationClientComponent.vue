            ...
            <section class="msger" id="chatBox2">
                <header class="msger-header">
                    <div class="msger-header-title">
                        <i class="fas fa-comment-alt"></i> {{ $t('message.Claim_Id') }} : <b>{{ this.formData2.id_reclamation
                        }}</b>
                    </div>
                        ...
                        <div class="msg left-msg mb-2" v-if="message.id_employe">
                            ...
                            <div class="msg-bubble">
                                <div class="msg-info">
                                    ...
                                    <div class="msg-info-time"><span><time-ago :datetime="message.created_at" long
                                                :locale="locale"></time-ago> </span></div>
                                </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="chercher">
                            <div class="search_bar">
                                ...
                                <vs-input :placeholder="$t('message.Search')" v-model="formDataCherche.valeur_recherche" @keyup.enter="getReclamations(formDataCherche3.selected_option3)"/>

                                <button class="btn-chercher" @click="getReclamations(formDataCherche3.selected_option3)"><i
                        ...
                        <vs-pagination v-if="locale == 'ar'" @input="getReclamations(0)" :max="9"
                            :total="reclamations.last_page" v-model="reclamations.current_page" prev-icon="arrow_forward"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="object_commande">{{ $t('message.Subject') }}<span class="text-danger">
                                    *</span></label>
                        ...
                        <div class="form-group">
                            <label for="message_reclamation">{{ $t('message.Message') }}<span class="text-danger">
                                    *</span></label>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary"
                            @click.prevent="addReclamation">{{ $t('message.Report') }}</button>
...
export default {
    ...
    data() {
        return {
            ...
            options2: [
                { text: this.$t('message.Default'), value: 'default' },
