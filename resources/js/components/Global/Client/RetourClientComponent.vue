    ...
    <div class="content-wrapper-customise">
        <div class="page-header-dashboard">
            <h3 class="page-title">
                ...
                Return receipt <b class="badge badge badge-gradient-secondary">{{nbrCommande}}</b>
            </h3>
        </div>
        <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <vs-table stripe multiple v-model="selected" @dblSelection="copyCommande"
                            :data="commandes.data">
                            <template slot="thead">
                                ...
                                <vs-tr :data="tr" :key="indextr" v-for="(tr, indextr) in data">
                                    ...
                                    <vs-td :data="tr.id_commande">
                                        ...
                                        <div class="additionalCommentaire">
                                            <span class="noreponse" v-if="tr.etat_commande == 'RETURNEDLV'">Return sent to agency</span>
                
                                            <span class="noreponse" v-if="tr.etat_commande == 'RETURNED'">Return send to hometown</span>
                                    ...
                                    <vs-td :data="tr.etat_commande">
                                        <button type="button" class="btn btn-valide"
                                            @click.prevent="receptionRetour(tr.id_commande)">
...
export default {
    ...
    methods: {
        async receptionRetour(id) {
            this.$vs.loading({ color: "#22c16b" });
            await axios.get("/api/receptionRetour/" + id).then(res => {

                if (res.data.data == 'Erreur') {
                    Swal.fire({
                        position: 'center',
                        icon: 'error',
                ...
                } else if (res.data.message == 'Commande RETURNED Successfully') {
                    this.$vs.notify({
                        title: res.data.message,
                        color: "success",
                        position: "top-right",
