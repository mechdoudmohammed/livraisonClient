...
export default {
    props: ['Client'],
    name: 'StatistiqueClientComponent',
    components: {
        DatePicker
    },
    data() {
    ...
    methods: {
        ...
        async getStatistiqueVille() {
            await axios.post('/api/statistiquesVille', this.formData)
                .then((res) => {
                    this.chartOptions2 = {
                        xaxis: {
                            categories: res.data.data2
