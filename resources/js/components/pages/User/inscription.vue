              ...
              <div class="wrap d-md-flex">
                ...
                <div class="login-wrap p-4 p-lg-5">
                  ...
                  <div class="form-group">
                            ...
                            <v-select  
                                v-model="formData.ville" name="ville_client" :options="villes"
                                label="ville" index="id" />
                        </div>
                    <div class="form-group mb-3">
                      <label class="label" for="name">Username</label>
                      <input type="text" class="form-control" placeholder="Username" v-model="formData.username" required>
                    </div>
                    <div class="form-group mb-3">
                    ...
                    <div class="form-group">
                      <button type="button" class="form-control btn btn-primary submit px-3" @click="inscription">S'inscrire</button>
                    </div>
...
export default{
        ...
        methods:{
            ...
            await axios.post('api/inscription',this.formData).then((response)=>{
