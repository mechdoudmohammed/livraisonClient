...
class FacturesRamasseurFacturation implements FromQuery,WithHeadings,WithColumnWidths,WithStyles
{
    /**
    ...
    */
    ...
    public function query()
    {
        ...
        ->selectRaw('employes.username,employes.ribBank,banques.nomBank,sum(factures.total_facture) as total')
        ...
        ->whereIn('factures.type_facture', ['ramasseurDaily'])
